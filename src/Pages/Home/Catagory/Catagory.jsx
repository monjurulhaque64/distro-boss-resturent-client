    ...
    return (
        <>
            ...
            >
                ...
                <h3 className='text-2xl uppercase text-center -mt-20 text-white'>Salads</h3></SwiperSlide>
                <SwiperSlide><img src={img2} alt="" />
                <h3 className='text-2xl uppercase text-center -mt-20 text-white'>pizza</h3></SwiperSlide>
                <SwiperSlide><img src={img3} alt="" /> <h3 className='text-2xl uppercase text-center -mt-20 text-white'>Soups</h3></SwiperSlide>
